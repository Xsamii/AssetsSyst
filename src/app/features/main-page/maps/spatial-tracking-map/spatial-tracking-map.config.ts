      ...
      content: [
        {
          type: 'fields',
          fieldInfos: [
            { fieldName: 'ItemName', label: 'اسم الأصل' },
            { fieldName: 'SystemName', label: 'النظام' },
            { fieldName: 'main_catogry', label: 'التصنيف الرئيسي' },
            { fieldName: 'sub_catogry', label: 'الفئة الفرعية' },
            { fieldName: 'SystemType', label: 'نوع النظام' },
            { fieldName: 'SystemClass', label: 'فئة النظام' },
            { fieldName: 'Material', label: 'المادة' },
            { fieldName: 'Type', label: 'النوع' },
            { fieldName: 'AssetCode', label: 'الرقم التعريفي' },
            { fieldName: 'EquipmentNo', label: 'رقم المعدة' },
            {
              fieldName: 'ManufacturerCompanyName',
              label: 'اسم الشركة المصنعة',
            },
            { fieldName: 'Countryoforigin', label: 'بلد المنشأ' },
            { fieldName: 'size', label: 'الحجم' },
            { fieldName: 'diameter', label: 'القطر' },
            { fieldName: 'Width', label: 'العرض' },
            { fieldName: 'Height', label: 'الارتفاع' },
            { fieldName: 'EmptyWeight', label: 'الوزن الفارغ' },
            { fieldName: 'OperatingWeight', label: 'الوزن التشغيلي' },
            { fieldName: 'Fluid_Medium', label: 'الوسط السائل' },
            {
              fieldName: 'AllowablePressureMax_Min',
              label: 'الضغط المسموح (أقصى/أدنى)',
            },
            {
              fieldName: 'AllowableTemperatureMax_Min',
              label: 'درجة الحرارة المسموحة (أقصى/أدنى)',
            },
            { fieldName: 'TestPressure', label: 'ضغط الاختبار' },
            { fieldName: 'TestDate', label: 'تاريخ الاختبار' },
            { fieldName: 'VesselYearBuilt', label: 'سنة البناء' },
            { fieldName: 'VesselSerialNo', label: 'الرقم التسلسلي' },
            { fieldName: 'HeatTreatment', label: 'المعالجة الحرارية' },
            { fieldName: 'NDTShell_Head', label: 'NDT Shell/Head' },
            { fieldName: 'ManufacturerAddress', label: 'عنوان الشركة المصنعة' },
            { fieldName: 'TelephoneNumber', label: 'رقم الهاتف' },
            { fieldName: 'ManufacturerWebsite', label: 'موقع الشركة المصنعة' },
          ],
        },
        {
          type: 'fields',
          fieldInfos: [
            { fieldName: 'RoomName', label: 'الغرفة' },
            { fieldName: 'LevelAsset', label: 'الدور' },
            { fieldName: 'BuildName', label: 'المبني' },
            { fieldName: 'slaughterhouseName', label: 'المجزة' },
          ],
        },
      ],
    },
