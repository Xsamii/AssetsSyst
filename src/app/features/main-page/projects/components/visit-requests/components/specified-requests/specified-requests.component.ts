...
@Component({
  selector: 'app-specified-requests',
  standalone: true,
  imports: [
    CommonModule,
    BreadCrumbComponent,
  ...
  templateUrl: './specified-requests.component.html',
  styleUrls: ['./specified-requests.component.scss'],
})
export class SpecifiedRequestsComponent implements OnInit {
  // --------------------------------------
  // VALUES
  // --------------------------------------
  selectedNodes;
  ...
  ngOnInit(): void {
    ...
    this.cols = [
      ...
      // new listColumns({ field: 'globalProjectName', header: 'طبيعة المشروع' }),
      new listColumns({
